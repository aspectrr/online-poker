...
export function RabbitMark(props: RabbitMarkProps) {
  ...
  return (
    ...
    >
      {/* ears */}
      <path
        d="M24 26c-2-10 0-20 4-21 3-1 4 8 4 19Z"
        fill="#fdf9f0"
        stroke="#d9c9a3"
        stroke-width="1.6"
      />
      <path
        d="M40 26c2-10 0-20-4-21-3-1-4 8-4 19Z"
        fill="#fdf9f0"
        stroke="#d9c9a3"
        stroke-width="1.6"
      />
      <path
        d="M26 22c-1-6 0-12 2-13M38 22c1-6 0-12-2-13"
        stroke="#e8b8b8"
        stroke-width="2"
      ...
      <path
        d="M32 41.5v1.8M32 43.3l-2 1.8M32 43.3l2 1.8"
        stroke="#2b2b2b"
        stroke-width="1.2"
        fill="none"
        stroke-linecap="round"
      ...
      {/* whiskers */}
      <path
        d="M18 38h-5M18 42l-5 2M46 38h5M46 42l5 2"
        stroke="#d9c9a3"
        stroke-width="1.1"
        stroke-linecap="round"
      />
      {/* buck teeth */}
      <path
        d="M30.5 45.5h3v3.2a1.5 1.5 0 0 1-3 0Z"
        fill="#fff"
        stroke="#d9c9a3"
        stroke-width="0.9"
      />
